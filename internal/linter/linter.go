...
func (l *Linter) SuggestCommitMessage() (*suggestion.CommitSuggestion, error) {
	analysis, err := suggestion.AnalyzeChanges()
	if err != nil {
	...
	suggestion, err := suggestion.SuggestCommitMessage(analysis)
	if err != nil {
